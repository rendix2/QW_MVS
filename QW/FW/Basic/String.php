...
class String extends Object
{
	...
	{
		return mb_strpos( $this->string, (string) $string, mb_strlen( $this->string, 'UTF-8' ) - mb_strlen( (string) $string, 'UTF-8' ), 'UTF-8' ) == TRUE ? TRUE : FALSE;
	}
	...
	public function indexOf( $char, $start = 0 )
	{
		...
		for ( $i = $start; $i < $strlen; $i++ ) {
			if ( $this->string{$i} == $char ) return $i;
		}
