...
<script type="text/javascript">
    {$index = ''}
    {if $display_mode}{$index = "$offset$template_name"|md5}{/if}
    _smarty_console = window.open("", "console{$index}", "width=680,height=600,left={$offset},top={$offset},resizable,scrollbars=yes");
