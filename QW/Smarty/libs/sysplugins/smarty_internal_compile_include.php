		...
		*/
		...
		if ( $merge_compiled_includes ) {
			...
			if ( !isset( $compiler->parent_compiler->mergedSubTemplatesData[ $tpl_name ][ $uid ] ) ) {
				...
				$compiler->parent_compiler->mergedSubTemplatesData[ $tpl_name ][ $uid ][ 'func' ] = $tpl->properties[ 'unifunc' ] = 'content_' . str_replace([ '.', ',' ], '_', uniqid('', TRUE));
				...
				if ( !( $tpl->source->uncompiled ) && $tpl->source->exists ) {
					...
					$compiler->parent_compiler->mergedSubTemplatesData[ $tpl_name ][ $uid ][ 'nocache_hash' ] = $tpl->properties[ 'nocache_hash' ] = str_replace([ '.', ',' ], '_', uniqid(rand(), TRUE));
					// get compiled code
