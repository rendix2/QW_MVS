<?php
	...
	class MathComplexNumber extends Object {
		...
		public function conjugate () {
			return new MathComplexNumber( $this->real, -$this->imaginary );
		}
		...
		public function minus ( MathComplexNumber $b ) {
			return new MathComplexNumber( $this->real - $b->real, $this->imaginary - $b->imaginary );
		}
		...
		public function mult ( MathComplexNumber $b ) {
			...
			return new MathComplexNumber( $real, $imag );
		}

		public function multAplha ( $alpha ) {
			return new MathComplexNumber( $this->real * $alpha, $this->imaginary * $alpha );
		}
		...
		public function reciprocal () {
			...
			return new MathComplexNumber( $this->real / $scale, -$this->imaginary / $scale );
		}
